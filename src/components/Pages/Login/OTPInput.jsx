...
const OtpInput = (props) => {
  ...
  return (
    <div className="flex max-w-lg gap-2 justify-between mt-6">
      ...
      {arr.map((_, index) => {
        return (
          <input
            ...
            className={
              className ||
              `input w-10 md:w-12 input-bordered px-0 text-center bg-transparent border-gray-600 focus:border-success transition-all text-success font-bold text-2xl`
            }
            type="text"
            inputMode="numeric"
